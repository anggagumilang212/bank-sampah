...
<body class=" bg-gray-800">
    ...
    <section class="p-6 text-gray-50">
        ...
        @foreach ($sampah as $item)
            <div class="p-6 py-5 bg-blue-400 text-gray-50 rounded-md m-2">
                <div class="container mx-auto">
                    <div class="flex flex-col lg:flex-row items-center justify-between">
                        <img src="{{ asset('fotojenissampah/' . $item->jenis_sampah->foto) }}" class="rounded-full w-20"
                            alt="fotosampah">
                        <h2 class="text-center text-lg tracki font-bold">Jenis Sampah :{{ $item->jenis_sampah->nama }}
                        </h2>
                        <div class="space-x-2 text-center py-2 lg:py-0">
                            <span class="font-bold text-lg">Total Harga :
                                RP.{{ number_format($item->jumlah * $item->jenis_sampah->harga, 3) }}</span>
                        </div>

                        <a href="{{ asset('delete-sampah/' . $item->id) }}" rel="noreferrer noopener"
                            class="px-5 mt-4 lg:mt-0 py-1 rounded-md border block bg-gray-50 text-gray-900 border-gray-400">Hapus</a>
                    </div>
                </div>
            </div>
        @endforeach
            ...
            <fieldset class="grid grid-cols-4 gap-6 p-6 rounded-md shadow-sm bg-gray-900">
                ...
                <div class="grid grid-cols-6 gap-4 col-span-full lg:col-span-3">
                    <div class="col-span-full sm:col-span-3">
                        ...
                        <select
                            class="w-full h-10 border rounded-md focus:ring focus:ri focus:ri border-gray-700 text-gray-900"
                    ...
                    <div class="col-span-full">
                        <div class="flex items-center space-x-2">
                            <button type="submit" class="px-4 py-2 border rounded-md border-gray-100">Submit</button>
                        </div>
                    </div>
                </div>
            </fieldset>
    ...
    <footer class="bg-gray-900 text-gray-50 m-5 rounded-md ">
            ...
            <div class="flex flex-col justify-center pt-6 lg:pt-0">
                <div class="flex justify-center space-x-4">
                    <a rel="noopener noreferrer" href="https://www.instagram.com/lionel_zexx/" title="Instagram"
                        class="flex items-center justify-center w-8 h-8 rounded-full sm:w-10 sm:h-10 bg-violet-400 text-gray-900">
